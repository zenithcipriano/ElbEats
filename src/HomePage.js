...
function HomePage({isMobile, submittedInput, keywords}) {
    ...
    const FilterForm = () => {
        ...
        <table className="priceTable1" style={{fontFamily: "Rubik", marginTop: isMobile ? (window.innerHeight - (95+68.36) + 18)/2 -180 : (window.innerHeight - (98) + 18)/2 - 180}} align='center'>
            ...
            <tr>
                <td colSpan={6}><input type="number" className='hmInput' name='rate' placeholder='5' max={5} min={1}/></td>
            </tr>
            <tr>
                <td colSpan={6}>Price</td>
            </tr>
            <tr>
                <td colSpan={2}><input type="number" className='hmInput' name='minPrice' placeholder='0' min={0} onChange={(event) => setMinPrice(event.target.value)}/></td>
                <td colSpan={2}> - </td>
                <td colSpan={2}><input type="number" className='hmInput' name='maxPrice' placeholder='100' min={minPrice}/></td>
            </tr>
            {/* <tr>
            ...
            <tr>
                <td colSpan={6}>Exclude dishes with this ingredient:</td>
            </tr>
            <tr>
                <td colSpan={6}>
                    {/* <table className='prtTBL' align='center'>
