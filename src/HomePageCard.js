...
class HomePageCard extends React.Component {
  ...
  async handleClose(choice) {
    ...
    if("View Restaurant Details" == choice) {
      ...
      const MM = now.getMonth()+1 < 10 ? "0"+now.getMonth() : now.getMonth();
          ...
          >
            ...
            <Card.Body style={{opacity: this.state.open ? 0.3 : 1}}>
                ...
                <table className='macro' style={{
                  ...
                  <tr>
                    <td> <div style={{marginRight:"5px", textAlign: 'left', 
                    whiteSpace: "nowrap",
                    overflow: "hidden",
                    textOverflow: "ellipsis"}}>*Calories: {this.state.calories}kcal</div></td>
                    <td> <div style={{textAlign: 'right', whiteSpace: "nowrap",
                    overflow: "hidden",
                    textOverflow: "ellipsis"}}>*Sodium: {this.state.sodium}mg </div></td>
                  </tr>
                </table>
